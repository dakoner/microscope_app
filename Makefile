...
INCPATH       = -I. -I/usr/include/x86_64-linux-gnu/qt6/Qsci -Isrc/microscope_app -Isrc/mindvision_qobject/Include -Isrc/mindvision_qobject/src -Isrc/serial_qobject/src -Isrc/led_controller_qobject/src -Isrc/yolo_inference_qobject/src -I/usr/include/x86_64-linux-gnu -I/usr/local/cuda/targets/x86_64-linux/include -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtSerialPort -I/usr/include/x86_64-linux-gnu/qt6/QtCore -Irelease/.moc -Irelease/.ui -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/microscope_app/MainWindow.h src/microscope_app/CNCControlPanel.h src/microscope_app/MosaicWidget.h src/microscope_app/MosaicPanel.h src/microscope_app/IntensityChart.h src/microscope_app/ColorPickerWidget.h src/led_controller_qobject/src/LEDController.h src/microscope_app/ScanConfigPanel.h src/yolo_inference_qobject/src/YOLOInferenceWorker.h src/microscope_app/PythonScintillaEditor.h src/mindvision_qobject/src/MindVisionCamera.h src/mindvision_qobject/src/VideoThread.h src/mindvision_qobject/src/mindvision_qobject_global.h src/serial_qobject/src/SerialWorker.h $(DISTDIR)/
	$(COPY_FILE) --parents src/microscope_app/main.cpp src/microscope_app/MainWindow.cpp src/microscope_app/CNCControlPanel.cpp src/microscope_app/MosaicWidget.cpp src/microscope_app/MosaicPanel.cpp src/microscope_app/IntensityChart.cpp src/microscope_app/ColorPickerWidget.cpp src/led_controller_qobject/src/LEDController.cpp src/microscope_app/ScanConfigPanel.cpp src/yolo_inference_qobject/src/YOLOInferenceWorker.cpp src/microscope_app/PythonScintillaEditor.cpp src/mindvision_qobject/src/MindVisionCamera.cpp src/mindvision_qobject/src/VideoThread.cpp src/serial_qobject/src/SerialWorker.cpp $(DISTDIR)/
