...
INCPATH       = -I. -Isrc/microscope_app -Isrc/mindvision_qobject/Include -Isrc/mindvision_qobject/src -Isrc/serial_qobject/src -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtSerialPort -I/usr/include/x86_64-linux-gnu/qt6/QtCore -Irelease/.moc -Irelease/.ui -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++
...
LIBS          = $(SUBLIBS) -Lsrc/mindvision_qobject/Lib -lMVSDK /usr/lib/x86_64-linux-gnu/libQt6Widgets.so /usr/lib/x86_64-linux-gnu/libQt6Gui.so /usr/lib/x86_64-linux-gnu/libGLX.so /usr/lib/x86_64-linux-gnu/libOpenGL.so /usr/lib/x86_64-linux-gnu/libQt6SerialPort.so /usr/lib/x86_64-linux-gnu/libQt6Core.so -lpthread -lGLX -lOpenGL   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/microscope_app/MainWindow.h src/microscope_app/CNCControlPanel.h src/microscope_app/MosaicWidget.h src/microscope_app/MosaicPanel.h src/microscope_app/IntensityChart.h src/microscope_app/ColorPickerWidget.h src/microscope_app/LEDController.h src/microscope_app/ScanConfigPanel.h src/mindvision_qobject/src/MindVisionCamera.h src/mindvision_qobject/src/VideoThread.h src/mindvision_qobject/src/mindvision_qobject_global.h src/serial_qobject/src/SerialWorker.h $(DISTDIR)/
	$(COPY_FILE) --parents src/microscope_app/main.cpp src/microscope_app/MainWindow.cpp src/microscope_app/CNCControlPanel.cpp src/microscope_app/MosaicWidget.cpp src/microscope_app/MosaicPanel.cpp src/microscope_app/IntensityChart.cpp src/microscope_app/ColorPickerWidget.cpp src/microscope_app/LEDController.cpp src/microscope_app/ScanConfigPanel.cpp src/mindvision_qobject/src/MindVisionCamera.cpp src/mindvision_qobject/src/VideoThread.cpp src/serial_qobject/src/SerialWorker.cpp $(DISTDIR)/
...
release/.moc/moc_predefs.h: /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/data/dummy.cpp
	g++ -pipe -O2 -std=gnu++2a -Wall -Wextra -fPIC -dM -E -o release/.moc/moc_predefs.h /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: release/.moc/moc_MainWindow.cpp release/.moc/moc_CNCControlPanel.cpp release/.moc/moc_MosaicWidget.cpp release/.moc/moc_MosaicPanel.cpp release/.moc/moc_IntensityChart.cpp release/.moc/moc_ColorPickerWidget.cpp release/.moc/moc_LEDController.cpp release/.moc/moc_ScanConfigPanel.cpp release/.moc/moc_MindVisionCamera.cpp release/.moc/moc_VideoThread.cpp release/.moc/moc_SerialWorker.cpp
